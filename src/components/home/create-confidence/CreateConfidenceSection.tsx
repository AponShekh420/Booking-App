					...
					<div className="relative grid place-content-center bg-black px-4 py-10 text-white sm:px-12 sm:py-12 lg:-left-1 lg:rounded-lg">
						...
						<form className="">
							<div className="flex h-10 w-full overflow-hidden rounded-lg sm:h-[4rem]">
								...
								/>
								<button className="relative flex h-full items-center text-nowrap border-2 border-custom-red bg-custom-red px-4 pt-[1%] font-heading text-xl text-white outline-none sm:px-8 sm:text-[2.5rem]">
									SIGN UP
								</button>
							</div>
						</form>
