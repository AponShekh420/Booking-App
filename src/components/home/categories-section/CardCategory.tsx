...
const CardCategory: FC<CardCategory5Props> = ({
	...
	const { count, name, href = '/', thumbnail, title, desc, clinicName, location, price } = taxonomy
	return (
		<Link href={href} className={`nc-CardCategory5 flex flex-col ${className}`}>
			...
			<div className="mt-[9.9px]">
				<h5
					className={`sm:text-[17.99px] font-bold lg:leading-[23.28px] text-left text-[13.27px] xs:text-[16.90px] sm:leading-[26.25px] xs:leading-[20.25px] leading-[19.25px]`}
				>
					<span className={"hover:text-custom-red transition-all duration-300"}>{title}</span>
					<br/>
					<span className='font-body font-[400] text-[11.99px] sm:text-[15.99px] xs:text-[13.99px] lg:text-[16.2px]'>{desc}</span>
					<p className='font-body font-[400] text-[11.99px] sm:text-[15.99px] xs:text-[13.99px] lg:text-[16.2px] sm:mt-[10px] xs:mt-[8px] mt-[5px]'>{clinicName} - {location}</p>
					<div className='flex justify-between items-center sm:mt-[10px] xs:mt-[8px] mt-[5px]'>
						<div className='font-[700] text-[13.99px] xs:text-[16.99px] lg:text-[17.99px] lg:leading-[29.28px] md:mt-[2.8px] mt-[2.5px]'>
							<span className='text-[10.03px] xs:text-[14.03px] font-[700] md:text-[16.99px] lg:text-[17.99px]'>From</span> £{price}
						</div>
