...
const HeroSection = () => {
  return (
    <header className="bg-[url('/assets/hero-banner.png')] bg-cover bg-center xl:h-[336px] h-[159px] sm:h-[210px] md:h-[250px] lg:h-[277px] w-full flex flex-col items-center">
      <Navbar/>
      <SearchBar/>
