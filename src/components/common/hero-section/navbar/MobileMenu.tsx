...
const MobileMenu: FC<MenuBarProps> = ({
					...
					<div className="fixed inset-0">
						<div className="flex min-h-full justify-end">
							<TransitionChild
								...
								enterFrom="opacity-0 translate-x-56 rtl:translate-x-[-56px]"
								enterTo="opacity-100 translate-x-0"
								leave="transition duration-150 transform"
								leaveFrom="opacity-100 translate-x-0"
								leaveTo="opacity-0 translate-x-56 rtl:translate-x-[-56px]"
							>
	...
	return (
		<>
			...
			>
        <MobileMenuIcon className="w-7 h-auto" />
			</button>
