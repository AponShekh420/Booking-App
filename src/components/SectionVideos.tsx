	...
	return (
		<div className={`nc-SectionVideos ${className}`}>
			...
			<div className="relative flex flex-col sm:py-4 sm:pe-4 md:py-6 md:pe-6 lg:flex-row xl:py-14 xl:pe-14">
				<div className="absolute -bottom-4 -end-4 -top-4 z-0 w-2/3 rounded-3xl bg-primary-100 bg-opacity-40 dark:bg-neutral-800 dark:bg-opacity-40 sm:rounded-[50px] md:bottom-0 md:end-0 md:top-0 xl:w-1/2"></div>
				<div className="relative flex-grow pb-2 sm:pb-4 lg:pb-0 lg:pe-5 xl:pe-6">
					{renderMainVideo()}
				</div>
