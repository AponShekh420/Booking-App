		...
		>
			<div>
				...
				<div className="hidden md:block">
					...
					<div className="md:mt-2 lg:mt-3 xl:mt-[14px]">
						<div className="flex w-full justify-between">
							...
							<div className="hidden cursor-pointer items-center gap-1 text-[14.7px] font-semibold transition-all duration-300 hover:text-custom-red md:text-[10px] lg:flex lg:text-[13px] xl:text-[18.64px]">
				...
				<div className="my-6 flex justify-between text-[14.7px] md:text-[14px] lg:text-[16px] xl:text-[18.64px]">
					<div>
				...
				<div className="flex items-start gap-1 gap-x-2 text-[14.7px] font-semibold md:text-[14px] lg:text-[16px] xl:text-[18.64px]">
					<WatchIcon className="h-4 w-4 md:h-6 md:w-6" />
					<p>Thursday 28th November - 11:00-12:00pm</p>
				</div>
				<div className="mt-2 flex w-auto cursor-pointer items-center gap-x-2 text-[14.7px] font-semibold transition-all duration-300 hover:text-custom-red md:text-[14px] lg:hidden lg:text-[16px] xl:text-[18.64px]">
					<LocationIconTwo className="h-4 w-4 md:h-6 md:w-6" />
					<p>114 New Cavendish St, London W1W 6XT</p>
				</div>
			</div>
			<hr className="my-4" />
			<div className="flex justify-between text-[27px] font-semibold md:text-[21px] lg:text-[25px] xl:text-[30px]">
				<h5>Total</h5>
				<h5>£200</h5>
			</div>
